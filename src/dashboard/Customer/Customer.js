                  ...
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th
                        ...
                        className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6"
                      >
                       <p className="flex"> Name <span className=" ml-2 cursor-pointer"><BsArrowDownUp></BsArrowDownUp></span></p>
                      </th>
                      <th
                        scope="col"
                        className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
                      >
                        <p className="flex">Email <span className=" ml-2 cursor-pointer"><BsArrowDownUp></BsArrowDownUp></span></p>
                      </th>
                      <th
                        scope="col"
                        className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
                      >
                <p className="flex">        Location <span className=" ml-2 cursor-pointer"><BsArrowDownUp></BsArrowDownUp></span></p>
                      </th>
                      <th
                        scope="col"
                        className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
                      >
                      <p className="flex">  Phone <span className=" ml-2 cursor-pointer"><BsArrowDownUp></BsArrowDownUp></span></p>
                      </th>
                      <th
                        scope="col"
                    ...
                    {people.map((person) => (
                      <tr key={person.email}>
                        ...
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                          ...
                          >
                            <FiEdit></FiEdit> <span className="sr-only">, {person.name}</span>
                          </Link>
                        </td>
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                          <Link
                            ...
                            className="text-indigo-600 hover:text-indigo-900"
                          >
                        <GrView></GrView> <span className="sr-only">, {person.name}</span>
                          </Link>
                        </td>
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                          <Link
                          ...
                          >
                            <AiTwotoneDelete></AiTwotoneDelete><span className="sr-only">, {person.name}</span>
                          </Link>
                        </td>
                      </tr>
                    ))}
